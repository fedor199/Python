...
# В качестве улучшения алгоритма используется переменная-флаг check для сокращения ненужных проходов и уменьшено количество 
# итераций в цикле c  использованием переменной n.
